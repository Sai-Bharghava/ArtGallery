...
<body>
    ...
    <nav class="navbar">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="userhomepaintings">Paintings ▼</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="userhomephotography">Photography ▼</a>
          <div class="hover-menu">
            <ul class="category-list">
              <li><h5>STYLE</h5></li>
              <hr>
        ...
        <li class="nav-item">
          <a class="nav-link" href="userhomedrawings">Drawings ▼</a>
          <div class="hover-menu">
            <ul class="category-list">
              <li><h5>STYLE</h5></li>
              <hr>
...
<div class="mainhead">
  <b><h1 style="color: black; align-items: center; text-align: center;"> Paintings</h1></b> 
 </div>
 <div class="card">
